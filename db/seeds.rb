...
comp = Competency.create(ref: "500", name: 'Développement')
  comp1 = Competency.create(ref: "501", name: 'Front end', parent_competency: comp)
    Competency.create(ref: "501.1", name: 'CSS', parent_competency: comp1)
    Competency.create(ref: "501.2", name: 'HTML', parent_competency: comp1)
    Competency.create(ref: "501.3", name: 'UI', parent_competency: comp1)
    Competency.create(ref: "501.4", name: 'UX', parent_competency: comp1)
  comp1 = Competency.create(ref: "502", name: 'Back end', parent_competency: comp)
    Competency.create(ref: "502.1", name: 'Ruby', parent_competency: comp1)
    Competency.create(ref: "502.2", name: 'JS', parent_competency: comp1)
    Competency.create(ref: "502.3", name: 'React', parent_competency: comp1)
    Competency.create(ref: "502.4", name: 'C#', parent_competency: comp1)
