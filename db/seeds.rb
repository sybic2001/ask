...
Competency.create(ref: 501, name: 'Front end', parent_competency: comp)
Competency.create(ref: 502, name: 'Back end', parent_competency: comp)
Competency.create(ref: 503, name: 'Big data', parent_competency: comp)
